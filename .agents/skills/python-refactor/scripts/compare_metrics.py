...
def compare_complexity(before_file: Path, after_file: Path) -> dict[str, Any]:
    ...
    comparison = {
        "avg_complexity": {
            ...
            "change": calculate_percentage_change(before_metrics.avg_complexity, after_metrics.avg_complexity),
        ...
        "max_complexity": {
            ...
            "change": calculate_percentage_change(before_metrics.max_complexity, after_metrics.max_complexity),
        ...
        "avg_length": {
            ...
            "change": calculate_percentage_change(before_metrics.avg_length, after_metrics.avg_length),
        ...
        "max_length": {
            ...
            "change": calculate_percentage_change(before_metrics.max_length, after_metrics.max_length),
        ...
        "avg_nesting": {
            ...
            "change": calculate_percentage_change(before_metrics.avg_nesting, after_metrics.avg_nesting),
        ...
        "max_nesting": {
            ...
            "change": calculate_percentage_change(before_metrics.max_nesting, after_metrics.max_nesting),
    ...
    comparison = {
        ...
        "docstring_coverage": {
            ...
            "change": calculate_percentage_increase(
                before_metrics.docstring_coverage_pct, after_metrics.docstring_coverage_pct
            ),
        ...
        "type_hint_coverage": {
            ...
            "change": calculate_percentage_increase(
                before_metrics.type_hint_coverage_pct, after_metrics.type_hint_coverage_pct
            ),
...
def print_comparison(complexity: dict[str, Any], documentation: dict[str, Any]):
    ...
    print(f"\n{'=' * 70}")
    print("Refactoring Metrics Comparison")
    print(f"{'=' * 70}\n")
...
def main():
    parser = argparse.ArgumentParser(description="Compare code metrics before and after refactoring")
    ...
    if args.json:
        output = {"complexity": complexity_comparison, "documentation": documentation_comparison}
