...
class ConvertAction(Action):
    def __init__(self, target_format: str, quality: int = 90, 
...
class BatchEngine:
    ...
    def execute_rules(self, images: List[Dict[str, Any]], rules: List[Rule], dry_run: bool = False) -> List[ProcessingResult]:
        results = []
        for img in images:
            for rule in rules:
