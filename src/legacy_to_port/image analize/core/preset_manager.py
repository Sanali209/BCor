...
class PresetManager:
    ...
    def create_defaults(self):
        ...
        self.presets["Web Compact"] = [
            Rule(
                FormatCondition([".webp"], invert=True),
                ConvertAction(".webp")
            ),
            Rule(
        ...
        self.presets["Standardize to JPG"] = [
            Rule(
                FormatCondition([".jpg", ".jpeg"], invert=True),
                ConvertAction(".jpg")
            )
        ]
            ...
            for name, rule_dicts in data.items():
                ...
                for rd in rule_dicts:
                    ...
                    if act_type == "DeleteAction":
                        ...
                        action = ConvertAction(target_format=target, quality=qual, 
                                             conflict_strategy=strat, delete_original=del_orig)
