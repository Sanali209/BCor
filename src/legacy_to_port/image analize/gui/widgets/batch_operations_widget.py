...
from PySide6.QtWidgets import (QWidget, QVBoxLayout, QHBoxLayout, QPushButton, 
                             QProgressBar, QTextEdit, QLabel, QCheckBox, QSplitter,
                ...
                if rule.condition.evaluate(img):
                    ...
                    if res.success:
                        ...
                        if not self.dry_run and res.saved_bytes > 0:
                            act_type = "UNKNOWN"
                            if "DELETE" in res.action_taken: act_type = "DELETE"
                            elif "CONVERT" in res.action_taken: act_type = "CONVERT"
                            elif "SCALE" in res.action_taken: act_type = "SCALE"
