...
class RuleEditorWidget(QWidget):
    ...
    def update_cond_inputs(self) -> None:
        # Clear old params
    ...
    def update_act_inputs(self) -> None:
    ...
    def add_rule(self) -> None:
        ...
        condition: AreaCondition | SizeCondition | FormatCondition | None = None
        ...
        action: DeleteAction | ConvertAction | ScaleAction | None = None
