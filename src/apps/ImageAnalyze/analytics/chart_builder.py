...
import numpy as np
from matplotlib.backends.backend_qt5agg import FigureCanvasQTAgg  # type: ignore[attr-defined]
...
class ChartBuilder:
    ...
    def create_format_pie(data: dict[str, int]) -> FigureCanvasQTAgg:
        ...
        if sizes:
            ...
            centre_circle = plt.Circle((0, 0), 0.70, fc="#1e1e1e")  # type: ignore[attr-defined]
