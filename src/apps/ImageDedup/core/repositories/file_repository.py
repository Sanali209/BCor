...
class FileRepository:
    ...
    def add_ignored_pair(self, id1, id2, reason):
        """Legacy scalar method to add an ignored pair."""
        from core.models import FileRelation, RelationType
        rel = FileRelation(id1=id1, id2=id2, relation_type=RelationType(reason), distance=0.0)
        self.add_relations_batch([rel], overwrite=True)
